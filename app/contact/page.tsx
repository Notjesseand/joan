              ...
              <div className="relative z-10">
                ...
                <div className="mt-10 pt-8 border-t border-white/10">
                  ...
                  <div className="flex gap-3">
                    <a href="https://www.linkedin.com/in/joan-oji-934058190" target="_blank" rel="noopener noreferrer" className="w-11 h-11 bg-white/10 rounded-xl flex items-center justify-center hover:bg-[#0077b5] transition-all duration-300 hover:scale-110 hover:shadow-lg hover:shadow-[#0077b5]/30">
                    ...
                    <a href="https://web.facebook.com/joan.oji" target="_blank" rel="noopener noreferrer" className="w-11 h-11 bg-white/10 rounded-xl flex items-center justify-center hover:bg-[#1877f2] transition-all duration-300 hover:scale-110 hover:shadow-lg hover:shadow-[#1877f2]/30">
